    ...
    <div className="w-full max-w-md mx-auto bg-white border border-gray-200 rounded-lg shadow-sm mb-6">
      ...
      <div className="flex items-center justify-between p-3 ">
        <div className="flex items-center gap-3">
          <img
            src="https://raw.githubusercontent.com/ShindouAris/Client-Locket-cloned/refs/heads/main/public/locket-icon.png"
            alt="Avatar"
            className="w-10 h-10 rounded-full object-cover"
          />
          <div>
            <div className="text-sm font-semibold text-gray-800 flex items-center gap-1">
              {post?.user_info?.displayName || "Caption Kanade™"}{" • "}
              <div className="flex items-center space-x-1">
                ...
                {post?.user_info?.plan ? (
                  ...
                  <span className="px-2 py-0.5 text-xs rounded-full font-semibold shadow-md text-white bg-linear-to-t from-sky-500 to-indigo-500">
                    Api
                  </span> 
                )}
              </div>
      ...
      <div className="w-full aspect-[2/0.5] flex items-center justify-center">
        <button
          ...
          style={{
            background: `linear-gradient(to bottom, ${post?.colortop}, ${post?.colorbottom})`,
            color: post?.color,
          }}
        >
